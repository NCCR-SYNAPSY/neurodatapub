...
sys.path.insert(0, os.path.abspath('../neurodatapub'))
...
project = u'NeuroDataPub'
copyright = u'2021, Connectomics Lab, Lausanne, Switzerland & Contributors'.format(time.strftime("%Y"))
...
.. |pypirelease| replace:: {}
.. |vrelease| replace:: {}
""".format(f'neurodatapub=={release}', f'v{release}')
...
html_short_title = u'NeuroDataPub'
...
htmlhelp_basename = 'NeuroDataPubDoc'
...
latex_documents = [
    ('index', 'NeuroDataPub.tex', u'NeuroDataPub Documentation',
     u'Connectomics Lab, Lausanne, Switzerland and Contributors', 'manual'),
]
...
man_pages = [
    ('index', 'NeuroDataPub', u'NeuroDataPub Documentation',
     [u'Connectomics Lab, Lausanne, Switzerland and Contributors'], 1)
]
...
texinfo_documents = [
    ('index', 'NeuroDataPub', u'NeuroDataPub Documentation',
     u'Connectomics Lab, Lausanne, Switzerland and Contributors', 'NeuroDataPub',
     'Commandline tool with a graphical assistant to manage and publish '
     'NCCR-SYNAPSY neuroimaging datasets',
     'Science'),
]
